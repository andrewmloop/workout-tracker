...
export default function Loading(props) {
  return (
    <div className="absolute w-full flex justify-center items-center top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
      <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="100px" height="100px" viewBox="0 0 50 50" preserveAspectRatio="xMidYMid">
